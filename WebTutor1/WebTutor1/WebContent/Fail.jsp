...
<img src="images\校徽.jpg" width="70" height="70" />
	...
	<h3 style="font-size:30px">学生登录入口</h3></body>
...
<body link="white" alink="white" vlink="white">
	...
	<div id="inform">
			...
			<br/>
			<h2>登 录</h2>
			<form action="user0login" method="post">
				<input type="text" name="username" placeholder="用户名" required="">
				<input type="password" name="loadsecret" placeholder="密码" required="">
			
			<p style="color:#FF0000;text-align:left">账号或密码错误</p><br>
			...
			还没有账号？
			<a href="student.create.jsp">注册</a>
			</form>
			<div class="clear"></div>
