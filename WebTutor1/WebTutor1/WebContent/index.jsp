	 ...
	 <div id="header2";class="a";align="center">
		<p style="font-size:30px">家教服务系统</div>
					<div class="col-xs-10 text-right menu-1">
						<ul>
							<li class="btn-cta"><a href="student.login.jsp"><span>学生登录/注册</span></a></li>
							<li class="btn-cta"><a href="teacher.login.jsp"><span>教师登录/注册</span></a></li>
							<li><a><span></span></a></li>
							<li><a><span></span></a></li>
							<li class="btn-cta"><a href="adminstor.login.jsp"><span>管理员</span></a></li>
						</ul>
					</div>
				</div>
