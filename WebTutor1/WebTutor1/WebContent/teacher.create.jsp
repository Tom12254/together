...
<img src="images\校徽.jpg" width="70" height="70" />
	...
	<h3 style="font-size:30px">教师登录入口</h3></body>
...
<div id="inform">
			...
			<form action="adduser1" method="post">
				...
				<input type="text" Name="sex" placeholder="性别(男\女)" required="">
				<input type="text" Name="region" placeholder="地区" required="">
				<input type="text" Name="IDcardnum" placeholder="身份证号码" required="">
				<input type="text" Name="QQnum" placeholder="QQ号码" required="">
				<input type="password" Name="loadsecret" placeholder="密码" required="">
			...
			<div class="send-button w3layouts agileits">
				...
				已经注册账号 <a href="teacher.login.jsp">登录</a>
			</div>
			</form>
			<div class="clear"></div>
		</div>
