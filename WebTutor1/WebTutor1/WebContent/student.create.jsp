...
<img src="images\校徽.jpg" width="70" height="70" />
	...
	<h3 style="font-size:30px">学生注册</h3><br></body>
	<h3 align="right"><button><a href="index.jsp" class="abc">退出</button></a></h3>
<body link="white" alink="white" vlink="white">
<div id="inform">
	
			<h2>注 册</h2>
			
			<form action="adduser0" method="post">
			...
			<div class="send-button w3layouts agileits">
				...
				已经注册账号 <a href="student.login.jsp">登录</a>
			</div>
			</form>
			<div class="clear"></div>
		</div>
