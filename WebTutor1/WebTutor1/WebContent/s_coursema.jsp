...
<html>
		   			...
		   			<div class="row">
			   			<div class="col-md-8 col-md-offset-2 text-center slider-text">
			   				<div class="slider-text-inner">
			   					<h1>这里是您的课程表，您可以进行管理</h1>
								<h1>This is your  curriculum schedule, and you can manage it.</h1>
			   				</div>
			   			</div>
			   		</div>
		   		</div>
	...
	<table cellspacing="0" cellpadding="0">
			...
			<%ArrayList<String> stu_subjectlist = (ArrayList<String>)request.getAttribute("stu_subjectlist"); %>
			<%if (stu_subjectlist != null) {%>
			<%for(int i=0;i<stu_subjectlist.size()/6;i++){ %>
			<tr>
				<th>subject</th>
				<td><%out.print(stu_subjectlist.get(i*6)); %></td>
				<td><%out.print(stu_subjectlist.get(i*6+1)); %></td>
				<td><%out.print(stu_subjectlist.get(i*6+2)); %></td>
				<td><%out.print(stu_subjectlist.get(i*6+3)); %></td>
				<td><%out.print(stu_subjectlist.get(i*6+4)); %></td>
				<td><%out.print(stu_subjectlist.get(i*6+5)); %></td>
				<td><a href="evalute_s.jsp">评价</a></td>
			</tr>
			<%}} %>																																				
		</table>		
		</div>
