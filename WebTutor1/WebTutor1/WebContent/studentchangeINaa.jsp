...
<img src="images\校徽.jpg" width="70" height="70" />
	...
	<h3 style="font-size:30px">学生信息修改</h3><br></body>
	<h3 align="right"><a href="studentchangeINa.jsp">退出</a></h3>
...
<div id="inform">
			...
			<form action="#" method="post">
				...
				<input type="text" Name="QQnumber" placeholder="QQ号码" required="" value= <s:property value="QQnumber"/>>
