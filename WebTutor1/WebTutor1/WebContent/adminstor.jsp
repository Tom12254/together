					...
					<div class="col-xs-10 text-right menu-1">
						<ul>
							<li class="has-dropdown">
								<a>信息删除</a>
								<ul class="dropdown">
									<li><a href='<s:url action="updateteacher"></s:url>'>删除教师信息</a></li>
									<li><a href='<s:url action="updatestudent"></s:url>'>删除学生信息</a></li>
								</ul>
							</li>
							<li class="has-dropdown">
								<a>增加\删除管理员</a>
								<ul class="dropdown">
									<li><a href="adadd.jsp">增加管理员</a></li>
									<li><a href='<s:url action="updateadminstor"></s:url>'>删除管理员</a></li>
								</ul>
							</li>
							<li class="has-dropdown">
		   			...
		   			<div class="row">
			   			<div class="col-md-8 col-md-offset-2 text-center slider-text">
			   				<div class="slider-text-inner">
			   					<h1>欢迎来到家教管理系统</h1>
								<h1>Welcome to the System of home teaching</h1>
			   				</div>
			   			</div>
			   		</div>
		   		</div>
